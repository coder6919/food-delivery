...
function Header() {
    ...
    return (
        <div className='bg-white dark:bg-gray-900  dark:text-white'>
            <nav className='flex justify-between shadow-md h-20 items-center px-12'>
                ...
                <ul className='flex'>
                    ...
                    <div className='flex mx-4'>
                        <span className='mt-1'><FaRegUserCircle /></span>
                        <li className='px-2'> <Link to="/signIn">SIGNIN</Link></li>
                    </div>
                    <div className='flex mx-4'>
                        <span className='mt-1'><MdOutlineShoppingCart /></span>
